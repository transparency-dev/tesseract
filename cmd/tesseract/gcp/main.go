...
var (
	...
	allowSHA1                = flag.Bool("allow_sha1_signing_algorithms", false, "If true, allow chains that use SHA-1 based signing algorithms. This flag will eventually be removed, and such algorithms will be disallowed.")
